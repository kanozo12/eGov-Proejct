...
public class UserController {
	...
	public String userLogin(LoginDTO loginDTO, HttpSession session, Model model, HttpServletRequest req) throws Exception {
		...
		vo.setPassword(loginDTO.getPassword());
		
		UserVO user = service.loginUser(vo);
		if (user == null) {
			model.addAttribute("msg", msg);
			return "user/login.page";
		}
